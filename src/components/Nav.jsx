...
const Nav = ({isOpen}) => {
  return (
    <>
      {/* Mobile     */}
      <nav className={`${isOpen ? `translate-x-0` : `-translate-x-[190.25rem]`} fixed left-0 top-0 flex h-screen w-full items-center justify-start transition-all duration-500 lg-hdden`} >
